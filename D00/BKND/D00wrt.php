...
include("../../include/BKND/mysqli_server.php");                                 //引用檔 
 ...
 $trnarray=fldafterwrite('D00','1',$link,true);
     ...
     if($brr[$mArlth-2]==0){        //如果旗標指示為新增						   
	    $sql="select * from d00 where F01="."'".$brr[0]."'"; 
		...
		if($rows>0){			 
        	...
        	//以下處理MySQL記錄新增  	        
	           $mscnt="INSERT INTO d00(F01,F04,F02,F03)  VALUES (";  //先把準備插入記錄的SQL 語法前半段先寫在字串中	 			   
	           $mscnt.="'".$brr[0]."',";
	           $mscnt.="'".$brr[1]."',";
   	           $mscnt.="'".$brr[2]."',";	          			  
	   ...
	   $mscnt="UPDATE d00 SET F04="."'".$brr[1]."',";	    
	   $mscnt.="F02="."'".$brr[2]."',";	   
	   $mscnt.="F03="."'".$lastdate.$list4['F03']."'";
