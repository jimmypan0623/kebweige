...
require_once("../../include/BKND/auth_check.php"); //驗證
   ...
   if (substr($_POST['filename'],0,3)=="PGE"){	  
	  ...
	  if($total_pages<=1){
		  $sqlK="SELECT F01 FROM `c20` WHERE 1 "; 
	      $sql2=mysqli_query($link,$sqlK);
   	      $rows=@mysqli_num_rows($sql2);	   	      //主要是在此先算有幾筆資料而不再join處算
	      $total_pages=ceil($rows/$pagerows);
       }    
	   $sql="SELECT c20.F00,c20.F01,c20.F02,c20.F03,c20.F11,c20.F15,c20.F12,c20.F13,c20.F14,c20.F05,c20.F99,b01.F02 as F0B,b01.F04 as F0D FROM c20 "; 	   
	   $sql.=" left outer join b01 on b01.F01=c20.F01 ORDER BY c20.F01";
	...
	$afld=['F00','F01','F0B','F0D','F03','F02','F11','F15','F12','F13','F14','F05','F99'];
