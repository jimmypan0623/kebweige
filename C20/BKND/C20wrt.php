...
require_once "../../include/BKND/fieldDOMset.php"; // 引入     
     $trnarray=fldafterwrite('C20','1',$link,true);  	
     ...
     if($brr[$mArlth-2]==0){        //如果旗標指示為新增						   
	    $sql="select * from c20 where F01="."'".$brr[0]."'"; 
		...
		if($rows>0){			 
        	...
        	//以下處理MySQL記錄新增  	        
	           $mscnt="INSERT INTO c20(F01,F03,F02,F11,F15,F12,F13,F14,F05,F99)  VALUES (";  //先把準備插入記錄的SQL 語法前半段先寫在字串中	 			   
	           $mscnt.="'".$brr[0]."',";
	           $mscnt.="'".$brr[1]."',";
   	           $mscnt.="'".$brr[2]."',";	    
               $mscnt.="'".$brr[3]."',";
	   ...
	   $mscnt="UPDATE c20 SET F03="."'".$brr[1]."',";	    
	   $mscnt.="F02="."'".$brr[2]."',";	  
       $mscnt.="F11="."'".$brr[3]."',";	 
       $mscnt.="F15="."'".$brr[4]."',";	   	 
	    $mscnt.="F12="."'".$brr[5]."',";	  
