<?php
   ...
   $rows=0;
	...
	//////////// //將出貨計畫先存入預期結餘計算		
	$sql7="(SELECT c04.F00,c04.F01,c04.F02,c04.F06,(c04.F03-c04.F09-c04.F21)*(-1) AS RST FROM c04 ";
	$sql7.=" LEFT JOIN c03 ON c03.F01=c04.F01 "; 
	$sql7.="WHERE c04.F03-c04.F09-c04.F21>0 AND c03.F04='Y' ";			 
	$sql7.=") UNION(SELECT d04.F00,d04.F01,d04.F02,d04.F06,d04.F03-d04.F09-d04.F21 AS RST FROM d04 LEFT JOIN d03 ON d03.F01=d04.F01 ";
	$sql7.=" WHERE d04.F03-d04.F09-d04.F21>0 AND d03.F04='Y' AND d04.F02 IN (SELECT c04.F02 FROM c04 ";
	$sql7.=" LEFT JOIN c03 ON c03.F01=c04.F01 "; 
	$sql7.=" WHERE c04.F03-c04.F09-c04.F21>0 AND c03.F04='Y' ";		
    ...
    if (substr($_POST['filename'],0,3)=="PGE"){	  
	   ...
	   $total_pages=ceil($rows/$pagerows);   //如果非初始畫面則應有大於等於1的數字	
	    if($total_pages<=1){
		    $sqlK="SELECT `c04`.`F01` FROM `c04` LEFT JOIN c03 ON c03.F01=c04.F01 WHERE `c04`.`F03`-`c04`.`F09`-`c04`.`F21`>0 AND `c03`.`F04`='Y'"; 
		...
		$sql.=" LEFT JOIN (SELECT b11.F03,SUM(b11.F04) AS nTqty FROM b11 LEFT JOIN a14 ON a14.F01=b11.F01 WHERE (a14.F04='Y' AND a14.F12='Y') GROUP BY b11.F03 ) AS b11B ON b11B.F03=c04.F02 ";
	...
	while ($list3=mysqli_fetch_assoc($sql4)){
		$atr = array('rc_no'.$wthary[0]=>$list3['F00'],  		            	             
					 ...
					 'customer_name'.$wthary[10]=>$list3['F0E'], 
					 'customer_partn'.$wthary[11]=>$list3['F05'], 
