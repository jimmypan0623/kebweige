function selfTag(jsvsn){	
	...
	loadScript(`B04/B04.js?v=${jsvsn}`,function(){DrawTable();});		
    loadScript(`B04/B04rgst.js?v=${jsvsn}`);	 
	loadScript(`B04/C01srch.js?v=${jsvsn}`);	 
	loadScript(`C01/A01srch.js?v=${jsvsn}`);	
	loadScript(`C01/A09getno.js?v=${jsvsn}`);	
	loadScript(`B04/B01srch.js?v=${jsvsn}`);	
	loadScript(`B04/A14srch.js?v=${jsvsn}`);	
	loadScript(`include/confirmfunction.js?=${jsvsn}`);	
...
function prntproc(event){
	...
	var urlphp="C21/C21report.php?ourCompany="+ourcmp+"&queryNo="+headdata[0]+"&customNo="+headdata[1]+' '+headdata[2];		 
