<?php
   ...
   if (substr($_POST['filename'],0,3)=="PGE"){	  
	  ...
	  if($total_pages<=1){
	   ...
	   c01.F32,c01.F33,a01A.F03 as F03A,c01.F36,c01.F38,c01.F39,c01.F40,c01.F41,c01.F42,c01.F43,c01.F44 FROM `c01` 	  
	   ...
	   LEFT OUTER JOIN `a01` AS a01A  ON c01.F33=a01A.F01  
	   LEFT OUTER JOIN `a01` AS a01B  ON c01.F23=a01B.F01  	
		WHERE ".$fieldNo." like '%".$filterKey."%' order by ".$fieldNo ; 
   }	   
	$arr=array();	
