...
function TableToJson(args,nongs,tbno){	
	 ...
	 if (tbno==0){	
	      var url=mainrightValue+"/"+mainrightValue+"wrt.php?timestamp="+new Date().getTime();	
          
	 }else if(tbno==1){
		   var url=mainrightValue+"/"+mainrightValue+"bodywrt.php?timestamp="+new Date().getTime();	
	       
	 }else if (tbno==2){
		 var url=mainrightValue+"/"+mainrightValue+"hipswrt.php?timestamp="+new Date().getTime();		  
	 }
