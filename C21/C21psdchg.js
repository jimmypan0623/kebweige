function selfTag(jsvsn){	
	...
	loadScript(`C21/C21.js?v=${jsvsn}`,function(){DrawTable();});	
    loadScript(`C21/C21rgst.js?v=${jsvsn}`);	 
	loadScript(`C21/C01srch.js?v=${jsvsn}`);	 
...
function prntproc(event){
	...
	var urlphp="C21/C21report.php?ourCompany="+ourcmp+"&queryNo="+headdata[0]+"&customNo="+headdata[3];	
