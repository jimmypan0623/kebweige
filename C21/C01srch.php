...
//$sql3=$sql3."left outer join `a01` on `a01.F01`=`c01.F33` ";,`c01.F33`,`c01.F12`,`c01.F31`,`c01.F15`,`c01.F36`
 ...
 include("../include/mysqli_server.php");                              //引用檔   
	 ...
	 $sql3="SELECT c01.F01,c01.F04,c01.F05,c01.F07,c01.F39,c01.F32,c01.F33,a01.F03 as F0C,c01.F12,c01.F31,c01.F15,c01.F36 FROM c01 ";	 
	 $sql3=$sql3."left outer join a01 on c01.F33=a01.F01 ";
	 if(strlen($searchRecord)==0) {	  
         $sql3=$sql3."WHERE c01.F01=c01.F44 ";		
	 }else{
		   //$sql3=$sql3."WHERE c01.F01 like '%".$searchRecord."%' ";	 
		$sql3=$sql3."WHERE ".$fieldNo." like '%".$searchRecord."%' and c01.F01=c01.F44 "   ; 
	 }
