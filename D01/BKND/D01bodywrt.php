...
foreach($cart as $key=>$val){	   
    $brr[]=addslashes($val);		//要加入此函數避免中間有單引號錯亂addslashes
}
include("../../include/BKND/mysqli_server.php");          //引用檔   
require_once "../../include/BKND/fieldDOMset.php"; // 引入     
$trnarray=fldafterwrite('D01','2',$link,true);  
...
if($rows2==0){
    echo json_encode("料品編號錯誤"); 
     ...
     if($brr[$mArlth-2]==0){        //如果旗標指示為新增						   	    			 
        	...
        	//以下處理MySQL記錄新增  	        
	           $mscnt="INSERT INTO d02(F01,F03,F04,F06,F07,F13,F08,F11,F02,F15,F16,F10,F99)  VALUES (";  //先把準備插入記錄的SQL 語法前半段先寫在字串中	 			   
	           $mscnt.="'".$brr[0]."',";
	           $mscnt.="'".$brr[1]."',";
   	           $mscnt.="'".$brr[2]."',";	 
               $mscnt.="'".$brr[3]."',";	
	   ...
	   $mscnt="UPDATE d02 SET F04="."'".$brr[2]."',";	    
	   $mscnt.="F06="."'".$brr[3]."',";	   
	   $mscnt.="F07="."'".$brr[4]."',";	 
	   $mscnt.="F13="."'".$brr[5]."',";	 
	   $mscnt.="F08="."'".$brr[6]."',";	
