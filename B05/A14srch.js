function deptshow(event)
{
    ...
    var dept_no=target.parentNode.childNodes[0];
...
/*用JavaScript DOM 的建立方式建立如上列顯示之html標籤，同時把該有的css屬性加入以作彈跳視窗*/
	...
	dropsheet.appendChild(dropsheet_content);  //訊息內框加入	
				...
				/*  formJason.appendChild(rspnsv); */
	             ...
	             var url="B04/A14srch.php?timestamp="+new Date().getTime();   	               				 
...
function deptblkclose(event)  //關閉註冊彈出視窗
{
	if (typeof event=="undefined"){
		event=window.event;
	}
