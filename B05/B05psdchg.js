function selfTag(jsvsn){
	...
	loadScript(`B05/B05.js?v=${jsvsn}`,function(){DrawTable();});
    loadScript(`B05/B05rgst.js?v=${jsvsn}`);	 
	loadScript(`B05/C01srch.js?v=${jsvsn}`);	 
	loadScript(`C01/A01srch.js?v=${jsvsn}`);	
	loadScript(`C01/A09getno.js?v=${jsvsn}`);	
	loadScript(`B05/B01srch.js?v=${jsvsn}`);	
	loadScript(`B05/A14srch.js?v=${jsvsn}`);	
