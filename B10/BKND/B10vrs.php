...
if(trim($list2['F10'])=="Y"){    
	...
	foreach ($mscnt as $delvalue){
	 ...
	 $sql3="SELECT b1z.F01,b1z.F03,b1z.F04,b10.F02,b10.F05,b10.F90 FROM b1z,b10 WHERE b1z.F01='".$delmsg."' AND b10.F01='".$delmsg."' ORDER BY b1z.F03"; 		 
	...
	$mscnt="UPDATE `b10` SET `F10`='N',`F11`='".$lastdate.$list4['F03']."' WHERE `F01`='".$delmsg."'";								   
