...
$trnarray=fldafterwrite('D34','1',$link,true);  	
     ...
     if($brr[$mArlth-2]==0){        //如果旗標指示為新增						   
	    $sql="select * from d34 where F01="."'".$brr[1]."'and F02='".$brr[0]."' and F03='".$brr[2]."'"; 
		...
		if($rows>0){			 
        	...
        	//以下處理MySQL記錄新增  	        
	           $mscnt="INSERT INTO d34(F02,F01,F03,F04,F05)  VALUES (";  //先把準備插入記錄的SQL 語法前半段先寫在字串中	 			   
	           $mscnt.="'".$brr[0]."',";
	           $mscnt.="'".$brr[1]."',";
   	           $mscnt.="'".$brr[2]."',";	    
               $mscnt.="'".$brr[3]."',";   	          	   
