<?php
   ...
   if (substr($_POST['filename'],0,3)=="PGE"){	  
	  ...
	  if($total_pages<=1){
		  $sqlK="SELECT F01 FROM `d34` WHERE 1 "; 
	      $sql2=mysqli_query($link,$sqlK);
   	      $rows=@mysqli_num_rows($sql2);	   	      //主要是在此先算有幾筆資料而不再join處算
	      $total_pages=ceil($rows/$pagerows);
       }    
	   $sql="SELECT d34.F00,d34.F01,d34.F02,d34.F03,d34.F04,d34.F05,d01.F04 as F0E,b01.F02 as F0B FROM d34"; 	   
	   $sql.=" left outer join d01 on d01.F01=d34.F01"; 
	   $sql.=" left outer join b01 on b01.F01=d34.F02"; 
	   $sql.=" ORDER BY d34.F02";	   
