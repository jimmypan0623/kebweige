function selfTag(jsvsn){ 
	loadScript(`C34/JS/C34.js?v=${jsvsn}`,function(){DrawTable();});	 
	loadScript(`C34/JS/C34rgst.js?v=${jsvsn}`);
	loadScript(`C04/JS/C01srch.js?v=${jsvsn}`);
	loadScript(`C34/JS/B01srch.js?v=${jsvsn}`); 
