...
$trnarray=fldafterwrite('C02','1',$link,true);  
...
if($rows2==0){
    echo json_encode("無此客戶編號"); 
     ...
     if($brr[$mArlth-2]==0){        //如果旗標指示為新增						   
        	...
        	//以下處理MySQL記錄新增  	        
	           $mscnt="INSERT INTO c02(F03,F01,F04,F06,F07,F08,F13,F10,F11,F02,F15,F16,F99)  VALUES (";  //先把準備插入記錄的SQL 語法前半段先寫在字串中	 			   
	           $mscnt.="'".$brr[0]."',";
	           $mscnt.="'".$brr[1]."',";
   	           $mscnt.="'".$brr[2]."',";	    
               $mscnt.="'".$brr[3]."',";   	 
	   ...
	   $mscnt="UPDATE c02 SET F01="."'".$brr[1]."',";	    
	   $mscnt.="F04="."'".$brr[2]."',";	  
       $mscnt.="F06="."'".$brr[3]."',";	     
       $mscnt.="F07="."'".$brr[4]."',";	  
       $mscnt.="F08="."'".$brr[5]."',";	  
